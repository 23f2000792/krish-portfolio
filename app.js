    ...
    generateBlogPosts() {
        ...
        this.blogPosts.forEach(post => {
            ...
            blogCard.innerHTML = `
                ...
                <div class="blog-tags" style="margin-bottom: 12px;">
                ...
                <div class="blog-meta" style="margin-bottom: 15px;">
                 ...
                 <a href="${post.link}" target="_blank" class="cert-modal-btn" style="padding: 8px 18px; font-size: 0.8rem; border-radius: 10px;">Read Full Blog</a>
            `;
